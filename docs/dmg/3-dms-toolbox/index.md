...
Whenever you would otherwise make a number of [D20 Tests](/sources/dnd/free-rules/rules-glossary#D20Test) for identical monsters, the Mob Results table can help you determine the number of successful D20 Tests the monsters get without having to roll dice. Follow these steps:
...
\*Use this column for [Cylinders](/sources/dnd/free-rules/rules-glossary#CylinderAreaofEffect), [Emanations](/sources/dnd/free-rules/rules-glossary#EmanationAreaofEffect) (using the size of the Emanation rather than its radius), and [Spheres](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect).
...
#### Burnt Othur Fumes [(500 GP)](/equipment/554-burnt-othur-fumes)
...
#### Malice [(250 GP)](/equipment/558-malice)
...
#### Midnight Tears [(1,500 GP)](/equipment/559-midnight-tears)
...
#### Oil of Taggit [(400 GP)](/equipment/560-oil-of-taggit)
...
#### Pale Tincture [(250 GP)](/equipment/561-pale-tincture)
...
#### Purple Worm Poison [(2,000 GP)](/equipment/562-purple-worm-poison)
...
#### Serpent Venom [(200 GP)](/equipment/563-serpent-venom)
...
#### Torpor [(600 GP)](/equipment/564-torpor)
...
#### Truth Serum [(150 GP)](/equipment/565-truth-serum)
...
#### Wyvern Poison [(1,200 GP)](/equipment/566-wyvern-poison)
...
Your campaign world is likely to include settlements that characters can visit. The characters might even adopt one of these settlements as a home base, in or near which they can build their Bastions when they are of high enough level to do so (see [chapter 8](/sources/dnd/dmg-2024/bastions)).

The Settlements by Size table provides population ranges for villages, towns, and cities as well as the value of the most expensive item the settlement is likely to have for sale. Adjust these numbers as you wish to account for special circumstances. For example, a [Potion of Healing](/magic-items/8960641-potion-of-healing) (which costs 50 GP) is too expensive an item to purchase in most villages, but a village that happens to have an alchemist, an herbalist, or a potion brewer might have one or more such potions for sale.
...
A Ballista is a massive crossbow that fires heavy bolts. Loading a Ballista requires the [Utilize](/sources/dnd/free-rules/rules-glossary#UtilizeAction) action, and aiming it requires another Utilize action. Then a crew member can take the Ballista Bolt action.
...
A Cannon uses gunpowder or arcane power to propel heavy iron balls at destructive speeds. A Cannon is usually attached to a wooden frame with wheels. Loading a Cannon requires the [Utilize](/sources/dnd/free-rules/rules-glossary#UtilizeAction) action, and aiming it requires another Utilize action. Then a crew member can take the Cannonball action.
...
***Flamethrower.*** *Dexterity Saving Throw:* DC 15, each creature in a 60-foot-long, 5-foot-wide [Line](/sources/dnd/free-rules/rules-glossary#LineAreaofEffect). *Failure:* 14 (4d6) Fire damage, and the creature starts burning. *Success:* Half damage only.
...
***Toxic Keg (Requires Load and Aim).*** *Constitution Saving Throw:* DC 15, each creature in a 20-foot-radius [Sphere](/sources/dnd/free-rules/rules-glossary#SphereAreaofEffect) centered on a point 30 to 300 feet from the launcher. *Failure:* 14 (4d6) Poison damage. *Success:* Half damage.

A back-mounted, wooden catapult flings small kegs of toxic gas. Loading a Keg Launcher requires the [Utilize](/sources/dnd/free-rules/rules-glossary#UtilizeAction) action, and aiming it requires another Utilize action. Then a crew member can take the Toxic Keg action.
...
A Lightning Cannon is a small, bronze cannon inlaid with arcane runes and mounted on a heavy tripod device. It launches balls of crackling electricity. Aiming a Lightning Cannon requires the [Utilize](/sources/dnd/free-rules/rules-glossary#UtilizeAction) action, then a crew member can take the Lightning Ball action.
...
A Ram consists of a movable gallery equipped with a heavy log suspended from two roof beams by chains. The log is shod in iron and used to batter through doors and barricades. Positioning a Ram requires three [Utilize](/sources/dnd/free-rules/rules-glossary#UtilizeAction) actions. Then a crew member can use the Ram action.

The gallery roof gives the operators [Total Cover](/sources/dnd/free-rules/rules-glossary#Cover) against attacks and other effects from above.
...
You have [Advantage](/sources/dnd/free-rules/rules-glossary#Advantage) on saving throws against spells and other magical effects.
...
One nonmagical weapon in your possession becomes a [+1 Weapon](/magic-items/5400-weapon-1) while you wield it.
...
This Blessing grants you the benefits of a [Periapt of Wound Closure](/magic-items/9228921-periapt-of-wound-closure).
...
This Charm allows you to cast [Conjure Animals](/spells/2619044-conjure-animals). Once used three times, the Charm vanishes from you.
...
This Charm allows you to cast [Darkvision](/spells/2619082-darkvision). Once used three times, the Charm vanishes from you.
...
This Charm grants you the benefits of a [Ring of Feather Falling](/magic-items/4721-ring-of-feather-falling). These benefits last for 10 days, after which the Charm vanishes from you.
...
This Charm allows you to give yourself the benefit of a [Potion of Heroism](/magic-items/4709-potion-of-heroism) as a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction) action. Once you do so, the Charm vanishes from you.
...
This Charm has 3 charges. You can expend some of its charges to cast one of the following spells: [Greater Restoration](/spells/2618961-greater-restoration) (2 charges) or [Lesser Restoration](/spells/2619016-lesser-restoration) (1 charge). Once all its charges have been expended, the Charm vanishes from you.
...
This Charm allows you to give yourself the benefit of a [Potion of Vitality](/magic-items/5360-potion-of-vitality) as a [Magic](/sources/dnd/free-rules/rules-glossary#MagicAction) action. Once you do so, the Charm vanishes from you.
